...
namespace Dynatrace.OpenTelemetry.Exporter.Metrics.Utils.Tests
{
    ...
    public class NormalizeTests
    {
        ...
        [InlineData("invalid leading number", "1case", "case")]
        ...
        [InlineData("invalid multiple sections leading number", "0a.b", "a.b")]
        ...
        [InlineData("invalid leading hyphen", "-dim", "dim")]
        [InlineData("valid trailing hyphen", "dim-", "dim-")]
        [InlineData("valid trailing hyphens", "dim---", "dim---")]
        [InlineData("invalid empty", "", null)]
        [InlineData("invalid only number", "000", null)]
        [InlineData("invalid key first section only number", "0.section", null)]
        [InlineData("invalid leading character", "~key", "key")]
        [InlineData("invalid leading characters", "~0#key", "key")]
        ...
        [InlineData("invalid delete trailing invalid chars", "a$%@", "a")]
        [InlineData("invalid delete trailing invalid chars groups", "a.b$%@.c", "a.b.c")]
        ...
        [InlineData("invalid trailing characters", "a.b.+", "a.b")]
        ...
        [InlineData("invalid example 1", "0MyMetric", "MyMetric")]
        [InlineData("invalid example 2", "mÄtric", "m_tric")]
        [InlineData("invalid example 3", "metriÄ", "metri")]
        [InlineData("invalid example 4", "Ätric", "tric")]
        ...
        [InlineData("valid trailing hyphen", "dim-", "dim-")]
        [InlineData("valid trailing hyphens", "dim---", "dim---")]
        [InlineData("invalid leading multiple", "~0#dim", "dim")]
        [InlineData("invalid leading multiple hyphens", "---dim", "dim")]
        [InlineData("invalid leading colon", ":dim", "dim")]
        [InlineData("invalid chars", "~@#ä", "")]
        [InlineData("invalid trailing chars", "aaa~@#ä", "aaa")]
        [InlineData("valid trailing underscores", "aaa___", "aaa___")]
        [InlineData("invalid only numbers", "000", "")]
        [InlineData("valid compound key", "dim1.value1", "dim1.value1")]
        [InlineData("invalid compound leading number", "dim.0dim", "dim.dim")]
        [InlineData("invalid compound only number", "dim.000", "dim")]
        [InlineData("invalid compound leading invalid char", "dim.~val", "dim.val")]
        [InlineData("invalid compound trailing invalid char", "dim.val~~", "dim.val")]
        [InlineData("invalid compound only invalid char", "dim.~~~", "dim")]
        ...
        [InlineData("invalid leading whitespace", "   a", "a")]
        [InlineData("invalid trailing whitespace", "a   ", "a")]
        ...
        [InlineData("invalid example 2", "0Tag", "tag")]
        [InlineData("invalid example 3", "tÄg", "t_g")]
        [InlineData("invalid example 4", "mytäääg", "myt_g")]
        [InlineData("invalid example 5", "ääätag", "tag")]
        [InlineData("invalid example 6", "ä_ätag", "__tag")]
        ...
        [InlineData("invalid unicode", "\u0000a\u0007", "a")]
        ...
        [InlineData("invalid leading unicode NUL", "\u0000a", "a")]
        [InlineData("invalid only unicode", "\u0000\u0000", "")]
        [InlineData("invalid consecutive leading unicode", "\u0000\u0000\u0000a", "a")]
        [InlineData("invalid consecutive trailing unicode", "a\u0000\u0000\u0000", "a")]
        [InlineData("invalid trailing unicode NUL", "a\u0000", "a")]
